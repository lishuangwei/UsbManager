...
public class UsbFileListAdapter extends ArrayAdapter<UsbFile> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView icon = (ImageView) view.findViewById(R.id.type_icon);
        UsbFile file = files.get(position);
        if (file.isDirectory()) {
            typeText.setText(R.string.directory);
            icon.setImageDrawable(getContext().getDrawable(R.drawable.ic_fso_folder));
        } else {
            typeText.setText(R.string.file);
            icon.setImageDrawable(getContext().getDrawable(R.drawable.ic_fso_default));
        }
